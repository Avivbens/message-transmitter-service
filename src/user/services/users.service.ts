...
import { InjectCollection } from '../../common/db/decorators'
...
export class UsersService {
    ...
    constructor(
        @InjectCollection(Collections.User)
    ...
    public async addUser({ email, password, username, phoneNumber, companyId, isAdmin }: Partial<NewUser>) {
        ...
        return this.col.insertOne(userToAdd as never as User, { ignoreUndefined: true }).then((o) =>
    ...
    public async updateForAdmin(user: UserAdminEdit, userId: string) {
        ...
        return this.col.findOneAndUpdate(
            ...
            { $set: userToUpdate as UpdateFilter<User> },
